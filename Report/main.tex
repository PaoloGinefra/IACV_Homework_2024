...
% Input macro configs
\input{Report/Configuration_Files/macros}
...
\input{Report/Chapters/Chapter_1-Theory/chapter_1}


\input{Report/Chapters/Template/introduction_template}
\label{ch:intro_tamplate}

% Import of Chapter One from the template
\input{Report/Chapters/Template/chapter_1_template}
\label{ch:tamplate}%
